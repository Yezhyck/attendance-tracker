...
import ua.yezhyck.attendance.tracker.model.entity.Student;
...
import ua.yezhyck.attendance.tracker.model.mapper.StudyClassMapper;
...
public class StudyClassServiceImpl implements StudyClassService {
    ...
    public void removeStudyClassById(Long id) throws NoSuchStudyClassException {
        ...
        List<Student> studentsForDelete = studentRepository.findWithOneStudyClassByStudyClassId(id);
